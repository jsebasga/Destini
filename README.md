...
Destini, Developed by Sebastian Güiza, using Xcode and App Brewery

#  *** Destini ***

Destini tries to tell you a story but also you can control the story with the choice that you have

Everybody who wants to use this application, ¡¡¡ 

## Enjoy it !!!

![Main Screen](DestiniScreen.png)
